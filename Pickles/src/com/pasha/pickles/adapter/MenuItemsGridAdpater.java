...
public class MenuItemsGridAdpater extends BaseAdapter {
	...
	public MenuItemsGridAdpater(Activity activity) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.row_grid_menu, null);
		}
